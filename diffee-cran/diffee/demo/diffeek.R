...
### run the diffee
result = diffeek(cancerlist[[1]], cancerlist[[2]], W = matrix(1,26,26), g = 1:3)
...
plot.diffeek(result, graphlabel = label, graphlayout = layout)
...
plot.diffeek(result, graphlabel = label, type = "neighbour",index = nodeid, graphlayout = layout)
